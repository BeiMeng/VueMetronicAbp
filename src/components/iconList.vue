...
<template>
  <div class='iconList'>
        <metro-tabs v-model="activeTab">
            <metro-tab-item name="fontawesome" label="Fontawesome Icons">
             <div class="divList">
            ...
            <metro-tab-item name="simpleLineIcons" label="Simple line icons">
                <div class="divList">
                                        <div class="note note-success">
            ...
            <metro-tab-item name="glyphicons" label="Glyphicons">
                <div class="divList">
                                        <div class="note note-success">
